    ...
    while (true) {
        ...
        if (!buffering || BUFFERING_DURATION == 0) {
            ...
            if (clock() - startTime >= START_BUFFERING_TIME * CLOCKS_PER_SEC / 1000) {
                ...
                << " | Buffering threshold (ms): " 
                << START_BUFFERING_TIME 
                << " | Condition met: " 
                << (clock() - startTime >= START_BUFFERING_TIME * CLOCKS_PER_SEC / 1000) 
                << std::endl;
            ...
            if (clock() - startTime >= BUFFERING_DURATION * CLOCKS_PER_SEC / 1000) {
                ...
                << BUFFERING_DURATION 
                << " | Condition met: " 
                << (clock() - startTime >= BUFFERING_DURATION * CLOCKS_PER_SEC / 1000) 
                << std::endl;
